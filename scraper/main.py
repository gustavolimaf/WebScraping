...
Uso:
    ...
    python main.py --marcas byd toyota    # várias marcas de uma vez
    python main.py --todas                # todas as marcas do site
    python main.py --dry-run              # lista modelos/versões sem raspar
    python main.py --url <url_versao>     # versão única
"""
...
# Slugs de todas as marcas disponíveis no site (amplie conforme necessário)
TODAS_AS_MARCAS = [
...
def main():
    ...
    parser.add_argument("--marca",   default="byd",   help="Slug de uma única marca")
