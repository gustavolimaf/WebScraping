"""
cleaner.py -- Limpeza e validacao dos dados raspados.
...
Problemas identificados na amostra BYD:
  ...
  3. Inconsistencia de campo: "vao_livre_do_solo" vs "altura_minima_do_solo"
  4. Valor textual "Nao informado" onde deveria ser None/ausente
"""
...
# -- Mapeamento de campos sinonimos
# Normaliza nomes de campos que o site usa de forma inconsistente entre versoes.
CAMPOS_SINONIMOS: dict[str, str] = {
    "geral__vao_livre_do_solo": "geral__altura_minima_do_solo",
}

# -- Valor sentinel para "nao informado"
NAO_INFORMADO_VALORES = {"nao informado", "nao informado", "-", "n/d", "nd", ""}


# -- Regras de correcao de valor
# Cada regra: (campo, padrao_regex, substituto_ou_callable)
...
# Campos numericos (com unidade) que devem casar com o padrao esperado.
# Se nao casarem, loga um aviso mas mantem o valor original.
...
def limpar_ficha(ficha: dict) -> dict:
    """
    Aplica todas as transformacoes de limpeza a um registro de ficha tecnica.
    Retorna uma copia limpa sem modificar o original.
    """
...
def _normalizar_sinonimos(dados: dict) -> dict:
    """Renomeia campos sinonimos para o nome canonico."""
